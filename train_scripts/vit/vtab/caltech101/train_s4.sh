CUDA_VISIBLE_DEVICES=3,4,  python  -m torch.distributed.launch --nproc_per_node=2  --master_port=14336  \
	...
	--output  output/vtab/caltech101/vit_hsn \
	--amp --pretrained  \

# lr 1e-3  wd 5e-4  dp 0.1
