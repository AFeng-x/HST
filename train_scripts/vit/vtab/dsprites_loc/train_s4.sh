CUDA_VISIBLE_DEVICES=3,4,  python  -m torch.distributed.launch --nproc_per_node=2  --master_port=12101  \
	...
	--output  output/vtab/dsprites_loc/vit_hsn \
	--amp --pretrained \

# lr 5e-3 weight-decay 5e-4 dp 0.1
