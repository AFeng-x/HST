CUDA_VISIBLE_DEVICES=3,4,  python  -m torch.distributed.launch --nproc_per_node=2  --master_port=11223  \
	...
	--output  output/vtab/resisc45/vit_hsn \
	--amp --pretrained 

# lr 5e-3 weight 5e-4 dp 0.0
