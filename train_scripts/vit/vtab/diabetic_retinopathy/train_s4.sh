CUDA_VISIBLE_DEVICES=3,4,  python  -m torch.distributed.launch --nproc_per_node=2  --master_port=26662  \
	...
	--output  output/vtab/diabetic_retinopathy/vit_hsn \
	--amp --pretrained  

# lr 1e-3 weight 5e-5 dp 0.1
