...
def main():
    ...
    if args.evaluate:
        ...
        if model_ema is not None and not args.model_ema_force_cpu:
            ...
            new_dict = OrderedDict([('loss_ema', ema_eval_metrics['loss']), ('top1_ema', ema_eval_metrics['top1']), ('top5_ema', ema_eval_metrics['top5'])])
            # eval_metrics = ema_eval_metrics
            eval_metrics.update(new_dict)
            eval_metric = 'top1_ema'
